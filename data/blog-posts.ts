    ...
    content: [
      ...
      },
      {
        ...
        body: [
          ...
          "Relius uses a simple, all-inclusive tiered model. Small churches pay $29/month. Most mid-size churches pay $99/month. Large and multi-site churches get custom enterprise pricing. Every tier includes every feature-AI tools, giving, check-ins, groups, pastoral care, communications. No app bundles to calculate, no surprises when you grow.",
          "Here's a real example: A church of 800 people using Planning Center People, Giving, Check-Ins, Groups, and Services might pay around $180-220/month. That same church on Relius pays $99/month with more features included. The savings add up, and the simplicity reduces administrative overhead.",

...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description:
      "Affordable church management with AI features. Unlimited members, transparent pricing. Start your free trial today.",
  },
};
  ...
  mainEntity: [
    {
      ...
      acceptedAnswer: {
        "@type": "Answer",
        text: "Start with your church's needs. Basic is perfect for churches wanting solid core features. Pro adds the full Pastoral Care system for tracking prayer requests, follow-ups, and member milestones. Max is ideal if you want AI to help with sermon prep, content creation, and pastoral insights.",
      },
    },
    {
      "@type": "Question",
    ...
    },
    {
      ...
      acceptedAnswer: {
        "@type": "Answer",
        text: "Absolutely! Many churches start with Basic, add Pro for Pastoral Care features, and upgrade to Max when they're ready for AI. You can upgrade anytime and get immediate access to new features. Your data comes with you.",
      },
    },
    {
      "@type": "Question",

...
export const metadata: Metadata = {
  title: "Church Management Software Features | Automation & AI Tools",
  description:
    "Explore Relius church management features: volunteer scheduling, pastoral care tracking, church automation tools, AI content creation, and workflow automation. See how churches save 10+ hours weekly.",
  openGraph: {
    title: "Church Management Software Features | Relius",
    description:
      "Church automation tools and AI features for volunteer scheduling, pastoral care, and ministry workflow automation.",
  },
};
